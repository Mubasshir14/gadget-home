            ...
            <li>
                <Link to='/cart' aria-label="Shopping Cart">
                    <button className="gap-2 flex items-center">
                        ...
                        <div className="badge bg-[#59C6D2] badge-secondary border-0">{cart.length > 0 ? `+${cart.length}` : 0}</div>
                    </button>
                </Link>
            </li>
        </>
                ...
                <div className="navbar-start lg:px-4">
                    <div className="dropdown">
                        <div
                            tabIndex={0}
                            role="button"
                            className="btn btn-ghost lg:hidden text-[#59C6D2]"
                        >
                            <svg
                        ...
                        <ul
                            tabIndex={0}
                            className="menu menu-sm dropdown-content bg-base-100 rounded-box z-10 mt-3 w-52 p-2 shadow text-[#59C6D2]"
                        >
                            {navItem}
                        </ul>
                    </div>
                                    ...
                                    <ul className="absolute right-0 mt-2 w-48 bg-[#59C6D2] shadow-lg rounded-lg overflow-hidden z-10 border border-gray-200">
                                        ...
                                        <li>
                                            <button
                                                ...
                                                className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-[#59C6D2]/30 hover:border-2 hover:text-white transition-colors duration-200"
                                            >
                                                Sign Out
                                            </button>
                                        </li>
