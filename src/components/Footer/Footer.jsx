                    ...
                    <div className="lg:flex">
                        <div className="w-full -mx-6 lg:w-2/5">
                            <div className="px-6">
                                ...
                                <p className="max-w-sm mt-2 text-gray-500 ">Join 31,000+ others and never miss out on new products.</p>
                        ...
                        <div className="mt-6 lg:mt-0 lg:flex-1">
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                                ...
                                <div>
                                    ...
                                    <a href="#" className="block mt-2 text-sm text-gray-600  hover:underline">Recent Posts</a>
                                    <a href="#" className="block mt-2 text-sm text-gray-600  hover:underline">Popular Posts</a>
                                    <a href="#" className="block mt-2 text-sm text-gray-600  hover:underline">Categories</a>
                                </div>

                                <div>
                                    <h3 className="text-gray-700 uppercase ">Support</h3>
                                    <a href="#" className="block mt-2 text-sm text-gray-600  hover:underline">Help Center</a>
                                ...
                                <div>
                                    ...
                                    <a href="#" className="block mt-2 text-sm text-gray-600 hover:underline">Contact Us</a>
                                    <a href="#" className="block mt-2 text-sm text-gray-600 hover:underline">Support</a>
