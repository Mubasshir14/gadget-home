        ...
        <div>
            ...
            <div className='p-6 md:p-20 rounded-xl' style={{ backgroundImage: `url(${bg})` }}>
                <div className='p-6 md:p-20 rounded-xl shadow-xl shadow-black' style={{ backgroundImage: `url(${bg})` }}>
                    <div className="flex flex-col lg:flex-row w-full mx-auto overflow-hidden bg-white rounded-lg dark:bg-gray-800 lg:max-w-4xl">
                        <div className="hidden lg:block lg:w-1/2 bg-cover" style={{ backgroundImage: `url(${login})` }}></div>

                        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                            <div className="flex justify-center mx-auto">
                                <img className="w-auto h-7 sm:h-8" src={login} alt="Login" />
                            </div>
                            ...
                            <form onSubmit={handleLogIn}>
                                ...
                                <div className="mt-6">
                                    <input
                                        className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#59C6D2] rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50"
                                        type="submit"
                                        value="Sign In"
                                    />
                                </div>
